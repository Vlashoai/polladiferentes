...
const GROUP_MATCHES = [
  ...
  {id:2,fecha:'2026-06-11',hora:'20:00',grupo:'Grupo A',eq1:'Corea del Sur',eq2:'Rep. Checa'},
  {id:3,fecha:'2026-06-12',hora:'13:00',grupo:'Grupo B',eq1:'Canadá',eq2:'Bosnia y Herzeg.'},
  {id:4,fecha:'2026-06-12',hora:'19:00',grupo:'Grupo D',eq1:'Estados Unidos',eq2:'Paraguay'},
  {id:5,fecha:'2026-06-13',hora:'13:00',grupo:'Grupo B',eq1:'Qatar',eq2:'Suiza'},
  {id:6,fecha:'2026-06-13',hora:'16:00',grupo:'Grupo C',eq1:'Brasil',eq2:'Marruecos'},
  {id:7,fecha:'2026-06-13',hora:'19:00',grupo:'Grupo C',eq1:'Haití',eq2:'Escocia'},
  {id:8,fecha:'2026-06-13',hora:'22:00',grupo:'Grupo D',eq1:'Australia',eq2:'Turquía'},
  {id:9,fecha:'2026-06-14',hora:'11:00',grupo:'Grupo E',eq1:'Alemania',eq2:'Curazao'},
  {id:10,fecha:'2026-06-14',hora:'14:00',grupo:'Grupo F',eq1:'Países Bajos',eq2:'Japón'},
  {id:11,fecha:'2026-06-14',hora:'17:00',grupo:'Grupo E',eq1:'Costa de Marfil',eq2:'Ecuador'},
  {id:12,fecha:'2026-06-14',hora:'20:00',grupo:'Grupo F',eq1:'Suecia',eq2:'Túnez'},
  {id:13,fecha:'2026-06-15',hora:'10:00',grupo:'Grupo H',eq1:'España',eq2:'Cabo Verde'},
  {id:14,fecha:'2026-06-15',hora:'13:00',grupo:'Grupo G',eq1:'Bélgica',eq2:'Egipto'},
  {id:15,fecha:'2026-06-15',hora:'16:00',grupo:'Grupo H',eq1:'Arabia Saudita',eq2:'Uruguay'},
  {id:16,fecha:'2026-06-15',hora:'19:00',grupo:'Grupo G',eq1:'Irán',eq2:'Nueva Zelanda'},
  {id:17,fecha:'2026-06-16',hora:'13:00',grupo:'Grupo I',eq1:'Francia',eq2:'Senegal'},
  {id:18,fecha:'2026-06-16',hora:'16:00',grupo:'Grupo I',eq1:'Irak',eq2:'Noruega'},
  {id:19,fecha:'2026-06-16',hora:'19:00',grupo:'Grupo J',eq1:'Argentina',eq2:'Argelia'},
  {id:20,fecha:'2026-06-16',hora:'22:00',grupo:'Grupo J',eq1:'Austria',eq2:'Jordania'},
  {id:21,fecha:'2026-06-17',hora:'11:00',grupo:'Grupo K',eq1:'Portugal',eq2:'Rep. Dem. Congo'},
  {id:22,fecha:'2026-06-17',hora:'14:00',grupo:'Grupo L',eq1:'Inglaterra',eq2:'Croacia'},
  {id:23,fecha:'2026-06-17',hora:'17:00',grupo:'Grupo L',eq1:'Ghana',eq2:'Panamá'},
  {id:24,fecha:'2026-06-17',hora:'20:00',grupo:'Grupo K',eq1:'Uzbekistán',eq2:'Colombia'},
  {id:25,fecha:'2026-06-18',hora:'10:00',grupo:'Grupo A',eq1:'Rep. Checa',eq2:'Sudáfrica'},
  {id:26,fecha:'2026-06-18',hora:'13:00',grupo:'Grupo B',eq1:'Suiza',eq2:'Bosnia y Herzeg.'},
  {id:27,fecha:'2026-06-18',hora:'16:00',grupo:'Grupo B',eq1:'Canadá',eq2:'Qatar'},
  {id:28,fecha:'2026-06-18',hora:'19:00',grupo:'Grupo A',eq1:'México',eq2:'Corea del Sur'},
  {id:29,fecha:'2026-06-19',hora:'13:00',grupo:'Grupo D',eq1:'Estados Unidos',eq2:'Australia'},
  {id:30,fecha:'2026-06-19',hora:'16:00',grupo:'Grupo C',eq1:'Escocia',eq2:'Marruecos'},
  {id:31,fecha:'2026-06-19',hora:'18:30',grupo:'Grupo C',eq1:'Brasil',eq2:'Haití'},
  {id:32,fecha:'2026-06-19',hora:'22:00',grupo:'Grupo D',eq1:'Turquía',eq2:'Paraguay'},
  {id:33,fecha:'2026-06-20',hora:'11:00',grupo:'Grupo F',eq1:'Países Bajos',eq2:'Suecia'},
  {id:34,fecha:'2026-06-20',hora:'14:00',grupo:'Grupo E',eq1:'Alemania',eq2:'Costa de Marfil'},
  {id:35,fecha:'2026-06-20',hora:'18:00',grupo:'Grupo E',eq1:'Ecuador',eq2:'Curazao'},
  {id:36,fecha:'2026-06-20',hora:'22:00',grupo:'Grupo F',eq1:'Túnez',eq2:'Japón'},
  {id:37,fecha:'2026-06-21',hora:'10:00',grupo:'Grupo H',eq1:'España',eq2:'Arabia Saudita'},
  {id:38,fecha:'2026-06-21',hora:'13:00',grupo:'Grupo G',eq1:'Bélgica',eq2:'Irán'},
  {id:39,fecha:'2026-06-21',hora:'16:00',grupo:'Grupo H',eq1:'Uruguay',eq2:'Cabo Verde'},
  {id:40,fecha:'2026-06-21',hora:'19:00',grupo:'Grupo G',eq1:'Nueva Zelanda',eq2:'Egipto'},
  {id:41,fecha:'2026-06-22',hora:'11:00',grupo:'Grupo J',eq1:'Argentina',eq2:'Austria'},
  {id:42,fecha:'2026-06-22',hora:'15:00',grupo:'Grupo I',eq1:'Irak',eq2:'Francia'},
  {id:43,fecha:'2026-06-22',hora:'18:00',grupo:'Grupo I',eq1:'Noruega',eq2:'Senegal'},
  {id:44,fecha:'2026-06-22',hora:'21:00',grupo:'Grupo J',eq1:'Jordania',eq2:'Argelia'},
  {id:45,fecha:'2026-06-23',hora:'11:00',grupo:'Grupo K',eq1:'Portugal',eq2:'Uzbekistán'},
  {id:46,fecha:'2026-06-23',hora:'14:00',grupo:'Grupo L',eq1:'Inglaterra',eq2:'Ghana'},
  {id:47,fecha:'2026-06-23',hora:'17:00',grupo:'Grupo L',eq1:'Panamá',eq2:'Croacia'},
  {id:48,fecha:'2026-06-23',hora:'20:00',grupo:'Grupo K',eq1:'Rep. Dem. Congo',eq2:'Colombia'},
  {id:49,fecha:'2026-06-24',hora:'13:00',grupo:'Grupo B',eq1:'Suiza',eq2:'Canadá'},
  {id:50,fecha:'2026-06-24',hora:'13:00',grupo:'Grupo B',eq1:'Bosnia y Herzeg.',eq2:'Qatar'},
  {id:51,fecha:'2026-06-24',hora:'16:00',grupo:'Grupo C',eq1:'Escocia',eq2:'Brasil'},
  {id:52,fecha:'2026-06-24',hora:'16:00',grupo:'Grupo C',eq1:'Marruecos',eq2:'Haití'},
  {id:53,fecha:'2026-06-24',hora:'19:00',grupo:'Grupo A',eq1:'Rep. Checa',eq2:'México'},
  {id:54,fecha:'2026-06-24',hora:'19:00',grupo:'Grupo A',eq1:'Sudáfrica',eq2:'Corea del Sur'},
  {id:55,fecha:'2026-06-25',hora:'14:00',grupo:'Grupo E',eq1:'Ecuador',eq2:'Alemania'},
  {id:56,fecha:'2026-06-25',hora:'14:00',grupo:'Grupo E',eq1:'Curazao',eq2:'Costa de Marfil'},
  {id:57,fecha:'2026-06-25',hora:'17:00',grupo:'Grupo F',eq1:'Japón',eq2:'Suecia'},
  {id:58,fecha:'2026-06-25',hora:'17:00',grupo:'Grupo F',eq1:'Túnez',eq2:'Países Bajos'},
  {id:59,fecha:'2026-06-25',hora:'20:00',grupo:'Grupo D',eq1:'Turquía',eq2:'Estados Unidos'},
  {id:60,fecha:'2026-06-25',hora:'20:00',grupo:'Grupo D',eq1:'Paraguay',eq2:'Australia'},
  {id:61,fecha:'2026-06-26',hora:'13:00',grupo:'Grupo I',eq1:'Noruega',eq2:'Francia'},
  {id:62,fecha:'2026-06-26',hora:'13:00',grupo:'Grupo I',eq1:'Senegal',eq2:'Irak'},
  {id:63,fecha:'2026-06-26',hora:'18:00',grupo:'Grupo H',eq1:'Cabo Verde',eq2:'Arabia Saudita'},
  {id:64,fecha:'2026-06-26',hora:'18:00',grupo:'Grupo H',eq1:'Uruguay',eq2:'España'},
  {id:65,fecha:'2026-06-26',hora:'21:00',grupo:'Grupo G',eq1:'Egipto',eq2:'Irán'},
  {id:66,fecha:'2026-06-26',hora:'21:00',grupo:'Grupo G',eq1:'Nueva Zelanda',eq2:'Bélgica'},
  {id:67,fecha:'2026-06-27',hora:'15:00',grupo:'Grupo L',eq1:'Panamá',eq2:'Inglaterra'},
  {id:68,fecha:'2026-06-27',hora:'15:00',grupo:'Grupo L',eq1:'Croacia',eq2:'Ghana'},
  {id:69,fecha:'2026-06-27',hora:'17:30',grupo:'Grupo K',eq1:'Colombia',eq2:'Portugal'},
  {id:70,fecha:'2026-06-27',hora:'17:30',grupo:'Grupo K',eq1:'Rep. Dem. Congo',eq2:'Uzbekistán'},
  {id:71,fecha:'2026-06-27',hora:'20:00',grupo:'Grupo J',eq1:'Argelia',eq2:'Austria'},
  {id:72,fecha:'2026-06-27',hora:'20:00',grupo:'Grupo J',eq1:'Jordania',eq2:'Argentina'}
];

const KNOCKOUT_MATCHES = [
  {id:73,fase:'Ronda de 32',label:'Clasif. G1-A vs Clasif. G3',fecha:'2026-06-28'},
  {id:74,fase:'Ronda de 32',label:'Clasif. G1-B vs Clasif. G3',fecha:'2026-06-29'},
  {id:75,fase:'Ronda de 32',label:'Clasif. G1-C vs Clasif. G3',fecha:'2026-06-29'},
  {id:76,fase:'Ronda de 32',label:'Clasif. G1-D vs Clasif. G3',fecha:'2026-06-29'},
  {id:77,fase:'Ronda de 32',label:'Clasif. G1-E vs Clasif. G3',fecha:'2026-06-30'},
  {id:78,fase:'Ronda de 32',label:'Clasif. G1-F vs Clasif. G3',fecha:'2026-06-30'},
  {id:79,fase:'Ronda de 32',label:'Clasif. G1-G vs Clasif. G3',fecha:'2026-06-30'},
  {id:80,fase:'Ronda de 32',label:'Clasif. G1-H vs Clasif. G3',fecha:'2026-07-01'},
  {id:81,fase:'Ronda de 32',label:'Clasif. G1-I vs Clasif. G3',fecha:'2026-07-01'},
  {id:82,fase:'Ronda de 32',label:'Clasif. G1-J vs Clasif. G3',fecha:'2026-07-01'},
  {id:83,fase:'Ronda de 32',label:'Clasif. G1-K vs Clasif. G3',fecha:'2026-07-02'},
  {id:84,fase:'Ronda de 32',label:'Clasif. G1-L vs Clasif. G3',fecha:'2026-07-02'},
  {id:85,fase:'Ronda de 32',label:'Clasif. G2-A vs Clasif. G3',fecha:'2026-07-02'},
  {id:86,fase:'Ronda de 32',label:'Clasif. G2-B vs Clasif. G3',fecha:'2026-07-03'},
  {id:87,fase:'Ronda de 32',label:'Clasif. G2-C vs Clasif. G3',fecha:'2026-07-03'},
  {id:88,fase:'Ronda de 32',label:'Clasif. G2-D vs Clasif. G3',fecha:'2026-07-03'},
...
function buildNav(activePage) {
  ...
  nav.innerHTML = `
    <div class="nav-inner">
      <a href="../index.html" class="nav-logo">POLLA DEL <span>MUNDIAL</span></a>
